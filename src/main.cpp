...
uint256 hashGenesisBlock("0xe36ad6d7385ac28e14ce571d9f53c11e5dc4e3fc1877bace6f0ffcd472e130b8");
...
const string strMessageMagic = "Entcoin Signed Message:\n";
...
static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // Entcoin: 1 days
static const int64 nTargetSpacing = 120; // Entcoin: 2 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal Entcoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Entcoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xe36ad6d7385ac28e14ce571d9f53c11e5dc4e3fc1877bace6f0ffcd472e130b8");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "The rise of personal wealth";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1385844800; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 273635;

        if (fTestNet)
        {
            block.nTime    = 1385844800;
            block.nNonce   = 273635;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x69fb6712aba2b794aded02b10692d5ab3fe9e84ca411ce5c2c6810d0272365fe"));
